...
namespace _Scripts.Infrastructure
{
    public class ContainerFactory : MonoInstaller
    {
        ...
        public T Instantiate<T>(Object prefab, Vector3 position, Transform parent = null) where T : Component
            => Container.InstantiatePrefab(prefab, position, Quaternion.identity, parent).GetComponent<T>(); 
        
        public T Instantiate<T>(Object prefab, Transform parent = null) where T : Component
