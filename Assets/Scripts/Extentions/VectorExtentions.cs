...
namespace _Scripts.Extentions
{
    public static class VectorExtentions
    {
        ...
        public static Vector3 Clamp(this Vector3 vector, Vector3 minValues, Vector3 maxValues)
        {
            vector.x = Mathf.Clamp(vector.x, minValues.x, maxValues.x);
            vector.y = Mathf.Clamp(vector.y, minValues.y, maxValues.y);
            vector.z = Mathf.Clamp(vector.z, minValues.z, maxValues.z);
            return vector;
        }
        ...
        public static Vector3 AverageVector(this IEnumerable<Vector3> vectors)
        {
        ...
        public static Vector2 AverageVector(this IEnumerable<Vector2> vectors) => vectors.Select(vector => (Vector3) vector).AverageVector();
